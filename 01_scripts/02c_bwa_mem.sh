...
bwa mem -M -t $SLURM_CPUS_PER_TASK -R @RG\tID:${name}\tSM:${name}\tPL:Illumina $GENOME_FULL $RAWDATAFOLDER/SRR19221208.R1.trimmed.fastq.gz $RAWDATAFOLDER/SRR19221208.R2.trimmed.fastq.gz