...
nucmer --mum -t 4 -c 200 -p attempt3 stickleback_v5_assembly.fa brook_genome_hap1_v1.fa

show-coords attempt3.delta > coords3.txt

mummerplot --medium -t png -p attempt3attempt3.delta